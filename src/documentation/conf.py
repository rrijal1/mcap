...
project = "Multivariate Convex Regression with Adaptive Partitioning"
...
latex_documents = [
    (
        ...
        """Documentation of the Multivariate Convex Regression with Adaptive Partitioning project""",
        "Ram K Rijal",
        "manual",
    )
]
